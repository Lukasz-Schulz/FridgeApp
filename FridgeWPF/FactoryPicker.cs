...
{
    /// <summary>
    /// Singleton class holding list of availible ingredient factories 
    /// and a method which chooses factory by its name passed in the constuctor.
    /// </summary>
     sealed class FactoryPicker //SINGLETON umożliwiający wybieranie odpowiedniej fabryki na podstawie nazwy docelowego produktu
        ...
        /// <summary>
        /// Returns an ingredient factory which produces ingredients which name equals the passed string.
        /// </summary>
