...
{
    /// <summary>
    /// Provides connection and changes with MySql database.
    /// </summary>
                                                  ...
                                                  //zawiera narzędzia umożliwiające wprowadzanie zmian w wybranej bazie danych
    {
        ...
        /// <summary>
        /// Adds passed ingredient to the database.
        /// </summary>
        ...
        /// <summary>
        /// Shortens ingredient name to one word, to make it easier to compare in the database.
        /// </summary>
        ...
        /// <summary>
        /// Changes dot to coma to unify the double format.
        /// </summary>
        ...
        /// <summary>
        /// Adds the passed recipe to the database.
        /// </summary>
        ...
        /// <summary>
        /// Converts the passed recipe ingredient list to a string so it can be easly added to the database.
        /// </summary>
        /// <param name="recipe"></param>
        /// <returns></returns>
