...
{
    /// <summary>
    /// Abstract class for ingredients which can be hold in recipe or fridge lists.
    /// </summary>
    ...
    {                                        //konkretne egzemplarze tworzone są przy pomocy odpowiednich fabryk
        ...
        /// <summary>
        /// Takes the last module of instances name and returns it as a string.
        /// </summary>
        ...
        /// <summary>
        /// Subtracts amount of ingredient.
        /// </summary>
        /// <param name="amount"></param>
        /// <returns></returns>
