...
{
    /// <summary>
    /// Handles operations which compare lists of recipe and availible ingredients from the fridge.
    /// </summary>
    public class StateChecker // dostarcza narzędzia do porównywania stanu lodówki z listą składników z przepisu
    {
        ...
        /// <summary>
        /// A list to be filled with availible ingredients.
        /// </summary>
        ...
        /// <summary>
        /// Returns a list with unique ingredients and their summed amounts.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Compares amounts of availible ingredients with the recipe list.
        /// </summary>
